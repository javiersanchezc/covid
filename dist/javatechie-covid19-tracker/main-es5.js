...
var Covid19Component = /** @class */ (function () {
    function Covid19Component(service) {
    ...
    Covid19Component.prototype.getAllReports = function () {
        var _this = this;
        var resp = this.service.covid19Reports();
        resp.subscribe(function (report) { return _this.dataSource.data = report; });
    };
    Covid19Component.prototype.applyFilter = function (filterValue) {
...
var JavatechieCovid19Service = /** @class */ (function () {
    function JavatechieCovid19Service(http) {
        this.http = http;
    }
    JavatechieCovid19Service.prototype.covid19Reports = function () {
        return this.http.get("https://corona.lmao.ninja/v2/countries");
    };
    JavatechieCovid19Service.ctorParameters = function () { return [
    ...
    return JavatechieCovid19Service;
}());
